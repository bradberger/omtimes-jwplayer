    ...
    public function getSevenHTML()
    {
        ...
        if ($data) {
            ...
            if (count($parts) > 5) {
                ...
                $ret->streamStatus = (isset($parts[0])) ? strip_tags(array_shift($parts)) : 0;
                $ret->peakListeners = (isset($parts[0])) ? strip_tags(array_shift($parts)) : 0;
                $ret->maxListeners = (isset($parts[0])) ? strip_tags(array_shift($parts)) : 0;
                $ret->uniqueListeners = (isset($parts[0])) ? strip_tags(array_shift($parts)) : 0;
                $ret->bitrate = (isset($parts[0])) ? strip_tags(array_shift($parts)) : 0;
